...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y unzip wget git default-jdk chromium=90.0.4430.24~deb10u1 xorg vnc4server autocutsel lxde-core novnc python-websockify 
